        ...
        resources: {
            ...
            pl: {
                translation: {
                    ...
                    "Hi. My name is Marcin Parda.": "Cześć. Nazywam się Marcin Parda. Jestem 23-letnim React programistą pracującym w branży od 2020 roku. Od nastoletnich lat interesowałem się tworzeniem gier oraz lekkoatletyką.",
                    "When I realized that running": "Gdy zorientowałem się, że bieganie nie jest rzeczą, którą chcę zająć profesjonalnie zacząłem się dokształcać w dziedzinie game designu. Na początku studiów poznałem javascript i wsiąknąłem w tworzenie stron internetowych.",
                    "I started IT studies": "W swojej pracy tworzę aplikacje internetowe. Stosuję się do zasad SOLID i DRY. Regularnie sprawdzam nowinki w programistycznym świecie frontendu. Posługuję się dobrze językiem angielskim na poziomie B2. Chętnie uczestniczę na targach IT i słucham kilku programistycznych podcastów.",
                    "Projects": "Projekty",
                    "Contact": "Kontakt",
